...
for i=1:N
    ...
    [sNoise fo to] = spectrogram(yNoise, 1024, 512, 256, 224);    
    [sEvoked fo to] = spectrogram(yEvoked, 1024, 512, 256, 224);
    [sInduced fo to] = spectrogram(yInduced, 1024, 512, 256, 224);
